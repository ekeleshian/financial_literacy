...
"CheckingAccount?",
"SavingsAccount?",
"IncomeFromWorkingPastYear?",
"IncomeFromPensionPastYear?",
"IncomeFromRetirementAccountsPastYear?",
 "IncomeFromSocialSecurityPastYear?",
"IncomeFromOtherFedOrStateBenefitsPastYear?",
"IncomeFromBusinessPastYear?",
"IncomeFromFamilyPastYear?",
"OwnHome?",
"CurrentlyMortgages?",
"EquityLoans?",
...
"EquityLoans?",
 "MortgageDebtVsValue",
"FrequencyLateMortgagePastYear",
"HowManyCreditCards",
"PayCreditCardsInFullAlways?",
"CreditCardChargedInterest?",
"CreditCardMinPaymentOnly?",
"CreditCardLateFee?",
"CreditCardExceedCreditLine?",
"CreditCardCashAdvance?",
"ResearchBeforeCreditCard?",
"AutoLoan?",
"UnpaidMedical?",
"StudentLoans?1=Y",
"StudentLoansFromPartner?",
"StudentLoansFromChild?",
"StudentLoansFromGrandchild?",
"StudentLoansFromOther?",
"StudentLoanPaymentDeterminedByIncome?",
 "StudentLoansCalculations?",
"CompleteEducationalProgram?",
"FrequencyLateStudentLoanPayment",
"StudentLoansWorried?",
"StudentLoansProcessDoItAgain?",
"Past5YearsAutoTitleLoan?",
"Past5YearsPayDayLoan?",
"Past5YearsPawnShop",
"Past5YearsRentToOwnStore?",
"BoughtAtPawnShop?",
 "SoldAtPawnShop?",
"PawnedAtPawnShop?",
 "DontKnowAtPawnShop?",
...
"TooMuchDebt?",
"HealthInsurance?",
"NoMedicineBecauseCost?",
"SkippedMedicalTestBecauseCost?",
"IgnoreMedicalProblemBecauseCost?",
"GoodWithYourMoney?",
 "GoodAtMath?",
"FinancialKnowledge?",
"FinancialEducationOfferedAtSchoolOrWork?",
